  ...
  .then(html => {
    processHTML3(html,accessToken);  // Call the function to process the HTML and extract CSRF token
  })
  .catch(error => {
    console.error('There was a problem with the fetch operation:', error);
  });

function processHTML3(htmlString,mrxw) {
  // Create a DOM parser
